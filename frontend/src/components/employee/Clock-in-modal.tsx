...
interface ClockInModalProps {
    ...
    currentTime: string;
    shiftTime: string;
    isClockedIn: boolean; // Add this prop
}
                ...
                <div className="p-5">
                    ...
                    <div className="flex justify-end gap-2 mt-6">
                        ...
                        <Button 
                            ...
                            className={`${isClockedIn ? "bg-green-500 hover:bg-green-600" : "bg-[#FF7A45] hover:bg-[#F05E21]"} text-white border-0 rounded-md px-4`}
                        >
