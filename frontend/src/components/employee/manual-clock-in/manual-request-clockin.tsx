...
import { PromptModal } from './promp-modal';
...
export default function ManualRequestModal({
    ...
    const { createManualRequest } = useManualRequest();
    const isLoading = createManualRequest.isPending;
    ...
    // Utility function to format date from "April 08, 2025" to "2025-04-08"
    ...
    // Utility function to format time from "hh : mm : AM/PM" to "HH:MM:00"
    ...
    // Function to render time inputs based on request type
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-5">
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm h-11"
                                >
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <Button
                                    type="submit"
                                    className="bg-orange-500 hover:bg-orange-600 text-white px-5 py-2 h-auto rounded-md font-medium transition-colors duration-200"
                                    disabled={isLoading} // Add loading state
                                >
